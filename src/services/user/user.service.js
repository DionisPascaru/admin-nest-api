        ...
        UserService_1.prototype.create = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.userRepository.create(createUserDto)];
                        case 1:
                            userData = _a.sent();
                            return [2 /*return*/, this.userRepository.save(userData)];
                    }
                });
            });
        };
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            userData = this.userRepository.merge(existingUser, updateUserDto);
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            existingUser = _a.sent();
                            return [4 /*yield*/, this.userRepository.remove(existingUser)];
                        case 2: return [2 /*return*/, _a.sent()];
                    }
                });
            });
